...
export const RedQueenRace = () => {
    ...
    const background1Movement= useWebAnimation({
    ...
    */    
    ...
    const background2Movement= useWebAnimation({
        keyframes: sceneryFrames,
        timing: sceneryTimingBackground,
     ...
     */
    const foreground1Movement= useWebAnimation({
        keyframes: sceneryFrames,
    ...
    /*  var foreground2Movement = foreground2.animate(
      sceneryFrames, sceneryTimingForeground);
    */
   const foreground2Movement = useWebAnimation({
    keyframes: sceneryFrames,
    timing: sceneryTimingForeground,
    ...
    */
    ...
    const redQueen_alice = useWebAnimation({
  ...
  <div className="sky">
    ...
    <div className="earth">
        ...
        ref={foreground1Movement.ref}>
            <img 
            id="palm3" 
            src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/palm3_small.png" srcSet="https://s3-us-west-2.amazonaws.com/s.cdpn.io/641/palm3.png 2x" 
            alt=" "
            />
        </div>
        <div 
        className="scenery" id="foreground2"
